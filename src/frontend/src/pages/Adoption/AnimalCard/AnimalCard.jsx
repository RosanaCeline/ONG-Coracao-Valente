...
const buildWhatsappUrl = (name, age) => {
  const message = `Olá! Vim pelo site da ONG Coração Valente e gostaria de saber mais sobre a adoção de *${name}*, de ${age}. Poderia me passar mais informações? 🐾`;
  ...
  return (
    <article className={styles.card}>
      ...
      <div className={styles.cardActions}>
        <a
          href={buildWhatsappUrl(name, age)}
          target="_blank"
          rel="noopener noreferrer"
          className={styles.whatsappBtn}
          aria-label={`Adotar ${name} via WhatsApp`}
        >
